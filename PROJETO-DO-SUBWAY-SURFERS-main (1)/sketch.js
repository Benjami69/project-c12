...
estradaImagem = loadImage("estrada.png");
 ...
 jogardorAnimacao = loadAnimation("Jake1.png","Jake2.png","Jake3.png","Jake4.png","Jake5.png");
}
...
function setup(){
  ...
  jogador.addAnimation("correndo",jogardorAnimacao);
